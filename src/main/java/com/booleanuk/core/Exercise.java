...
public class Exercise {
    ...
    public String protocol = lowerCasedUrl.substring(1,6);


    // 5. Using the appropriate string method on url, set the value of the domain member below
    public String domain = lowerCasedUrl.substring(9, 22);
    ...
    public String faqUrl = protocol.concat("://").concat(domain).concat("/").concat("faq");
}
