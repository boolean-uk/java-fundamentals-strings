...
public class Exercise {
    ...
    public String [] piecedURL = url.split("://");
    public String protocol = piecedURL[0];


    // 5. Using the appropriate string method on url, set the value of the domain member below
    public String[] anotherPiecedURL = piecedURL[1].split("/");
    public String domain = anotherPiecedURL[0];
    ...
    public String faqUrl = piecedURL[0]+"://"+anotherPiecedURL[0]+"/faq";
}
