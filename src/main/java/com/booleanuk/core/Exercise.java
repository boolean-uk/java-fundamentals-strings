...
public class Exercise {
    ...
    public String protocol = url.substring(0, index);


    // 5. Using the appropriate string method on url, set the value of the domain member below
    String[] partitions = url.split("/");
    public String domain = partitions[2];
    ...
    //public String faqUrl = url.replaceAll("([A-Za-z]+(-[A-Za-z]+)+)", "faq");
