...
public class Exercise {
    ...
    public String[] protoc = url.split("/");
    public String[] prot = url.split(":");
    public String protocol = prot[0];

    // 5. Using the appropriate string method on url, set the value of the domain member below
    public String domain = protoc[2];
    ...
    public String faqUrl = url.replace(protoc[3], "faq");
}
